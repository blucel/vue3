import { defineComponent, computed, openBlock, createElementBlock, normalizeStyle, renderSlot, createElementVNode, warn, getCurrentInstance, ref, inject, unref, watch, mergeProps, useSlots, Text, normalizeClass, Fragment, createBlock, withCtx, resolveDynamicComponent, createCommentVNode, provide, reactive, toRef, resolveComponent, createTextVNode } from 'vue';
import 'vue-demi';
...
const ElIcon$1 = withInstall$1(script$1);
...
var defaults = baseRest(function(object, sources) {
  ...
  while (++index < length) {
    ...
    while (++propsIndex < propsLength) {
      ...
      if (value === undefined ||
          (eq(value, objectProto$8[key]) && !hasOwnProperty$8.call(object, key))) {
...
export { ElIcon$1 as ElIcon, ElIcons, index as default };
